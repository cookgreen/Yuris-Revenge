...
{
    public class MoveUnderground : Activity
    {
        ...
        {
            protected readonly MoveUnderground Move;
        ...
        {
            public MoveFirstHalf(MoveUnderground move, WPos from, WPos to, int fromFacing, int toFacing, int startingFraction)
