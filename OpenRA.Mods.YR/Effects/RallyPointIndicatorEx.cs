 ...
 * Modded from RallyPointIndicator.cs
 * 
...
{
    class RallyPointIndicatorEx : IEffect, IEffectAboveShroud
    {
        ...
        public RallyPointIndicatorEx(Actor building, RallyPointEx rp, ExitInfo[] exits)
        {
