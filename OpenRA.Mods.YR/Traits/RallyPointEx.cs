...
namespace OpenRA.Mods.Common.Traits
{
    ...
    public class RallyPointExInfo : ITraitInfo
    {
        ...
        public object Create(ActorInitializer init) { return new RallyPointEx(init.Self, this); }
        
        [Desc("The speech notification to play when eastablish a new rally point.")]
        public readonly string NewRallyPointEastablishedNotification = "NewRallyPointEstablished";
    }

    public class RallyPointEx : IIssueOrder, IResolveOrder, ISync, INotifyOwnerChanged, INotifyCreated
    {
        const string OrderID = "SetRallyPoint";

        [Sync]
        public CPos Location;
        public RallyPointExInfo Info;
        ...
        public RallyPointEx(Actor self, RallyPointExInfo info)
        {
            Info = info;
            ResetLocation(self);
        ...
        {
            self.World.Add(new RallyPointIndicatorEx(self, this, self.Info.TraitInfos<ExitInfo>().ToArray()));
        }
        ...
        public void ResolveOrder(Actor self, Order order)
        {
            if (order.OrderString == OrderID)
            {
                ...
                Game.Sound.PlayNotification(self.World.Map.Rules, self.Owner, "Speech", Info.NewRallyPointEastablishedNotification, self.Owner.Faction.InternalName);
            }
        }
