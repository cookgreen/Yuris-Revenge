...
namespace OpenRA.Mods.Common.Traits
{
    ...
    public class MobileUndergroundInfo : ConditionalTraitInfo, IMoveInfo, IPositionableInfo, IFacingInfo,
        UsesInit<FacingInit>, UsesInit<LocationInit>, UsesInit<SubCellInit>, IActorPreviewInitInfo
    {
        ...
        public override object Create(ActorInitializer init) { return new MobileUnderground(init, this); }
    ...
    public class MobileUnderground : ConditionalTrait<MobileUndergroundInfo>, INotifyCreated, IIssueOrder, IResolveOrder, IOrderVoice, IPositionable, IMove,
        IFacing, IDeathActorInitModifier, INotifyAddedToWorld, INotifyRemovedFromWorld, INotifyBlockingMove, IActorPreviewInitModifier, INotifyBecomingIdle
    {
        ...
        public MobileUnderground(ActorInitializer init, MobileUndergroundInfo info)
            : base(info)
        {
            self = init.Self;
        ...
        IEnumerable<IOrderTargeter> IIssueOrder.Orders { get { yield return new MoveUndergroundOrderTargeter(self, this); } }

        // Note: Returns a valid order even if the unit can't move to the target
        Order IIssueOrder.IssueOrder(Actor self, IOrderTargeter order, Target target, bool queued)
        {
            if (order is MoveUndergroundOrderTargeter)
        ...
        class MoveUndergroundOrderTargeter : IOrderTargeter
        {
            readonly MobileUnderground mobile;
            ...
            public MoveUndergroundOrderTargeter(Actor self, MobileUnderground unit)
            {
                mobile = unit;
