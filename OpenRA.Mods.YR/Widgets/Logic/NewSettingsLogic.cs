...
{
	public class NewSettingsLogic : ChromeLogic
	{
		...
		public NewSettingsLogic(Widget widget, Action onExit, ModData modData, WorldRenderer worldRenderer, Dictionary<string, MiniYaml> logicArgs)
		{
